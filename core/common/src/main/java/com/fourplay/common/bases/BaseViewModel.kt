package com.fourplay.common.bases
...
abstract class BaseViewModel<UI_STATE : Parcelable, PARTIAL_UI_STATE, EVENT, INTENT>(
    ...
    val uiState = savedStateHandle.getStateFlow(com.fourplay.common.bases.SAVED_UI_STATE_KEY, initialState)
...
//                .catch { Timber.e("reduceUiState $it") }
                .collect {
                    savedStateHandle[com.fourplay.common.bases.SAVED_UI_STATE_KEY] = it
                }
        }
    }
