...
import com.base.network.getUnsafeOkHttpClient
import com.base.network.interceptors.AuthInterceptor
import com.base.network.interceptors.CustomHeadersInterceptor
...
class NetworkModule {
    ...
    private val stageBaseUrl = "https://test.com/"
